...
- Code-check round 4 on Phase 3 docs (`review-round4.md`): clean; every inline number re-derived from the chunk code. One loose phrase tightened ("every threshold" -> "thirty times the 5,000 m² threshold").
- Note: the Phase 3 checkbox flips rode in the Phase 2 commit (task_plan.md was already staged when Phase 2 was committed); the Phase 3 work itself lands here.
